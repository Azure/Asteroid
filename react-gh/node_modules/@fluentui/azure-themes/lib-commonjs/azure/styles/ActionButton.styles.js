...
var ActionButtonStyles = function (theme) {
    ...
    return {
        root: tslib_1.__assign({ fontSize: theme.fonts.medium.fontSize, height: StyleConstants.commandBarHeight, backgroundColor: semanticColors.buttonBackground, color: semanticColors.buttonText }, iconColor(extendedSemanticColors.iconButtonFill)),
