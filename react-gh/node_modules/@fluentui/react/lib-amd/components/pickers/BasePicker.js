define(["require", "exports", "tslib", "react", "../../Utilities", "../../Callout", "../../utilities/selection/index", "../../common/DirectionalHint", "./Suggestions/Suggestions", "./Suggestions/Suggestions.styles", "./Suggestions/SuggestionsController", "./BasePicker.types", "../Autofill/index", "./BasePicker.scss"], function (require, exports, tslib_1, React, Utilities_1, Callout_1, index_1, DirectionalHint_1, Suggestions_1, Suggestions_styles_1, SuggestionsController_1, BasePicker_types_1, index_2, stylesImport) {
    ...
    var BasePicker = /** @class */ (function (_super) {
        ...
        BasePicker.prototype.renderSuggestions = function () {
            ...
            return this.state.suggestionsVisible && this.input ? (React.createElement(Callout_1.Callout, tslib_1.__assign({ isBeakVisible: false, gapSpace: 5, target: this.input.current ? this.input.current.inputElement : undefined, onDismiss: this.dismissSuggestions, directionalHint: DirectionalHint_1.DirectionalHint.bottomLeftEdge, directionalHintForRTL: DirectionalHint_1.DirectionalHint.bottomRightEdge }, this.props.pickerCalloutProps),
