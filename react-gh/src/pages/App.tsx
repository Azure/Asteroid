    ...
    <main id="main" className="wrapper">
      ...
      >
        ...
        <ExplanationButton
          ...
          explanationVideoLink="https://microsofteur-my.sharepoint.com/personal/t-orkanc_microsoft_com/_layouts/15/embed.aspx?UniqueId=b6a73f04-8aa6-4745-ac5e-6693990d1b70&embed=%7B%22ust%22%3Atrue%7D&referrer=StreamWebApp&referrerScenario=EmbedDialog.Create"
          headerText="Asteroid Explanation"
          explanationVideoTitle="Asteroid Explanation Video"
        />
      </Stack>
    </main>
  );
